...
var logger = log4js_1.default.getLogger('Starting');
/**
...
function init() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            log4js_1.default.configure(config.log);
            return [2 /*return*/];
        });
    });
}
...
function routes() {
    ...
    app.get('/health', function (req, res) { return res.sendStatus(200); });
    // Services Implementations
    app.use('/api', index_1.default);
    // Error 404
    app.use(function (req, res) { return res.sendStatus(404); });
    // Other errors
    app.use(function (err, req, res) { return res.sendStatus(500); });
}
/**
